...
class AccountDepositOperation extends Operation_1.default {
    ...
    runOperation() {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("\n>>> Iniciando depósito");
            let accountDepositNumber = yield this._inputHandler.getStringInput("Insira o número da Conta recebedora do depósito: ");
            try {
                let depositAccount = this._dataManager.getClientAccount(this._editedClient, accountDepositNumber);
                let depositValue = yield this._inputHandler.getNumberInput("Insira o valor do depósito: ");
...
exports.default = AccountDepositOperation;
