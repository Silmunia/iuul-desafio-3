...
class ListClientInfoOperation extends Operation_1.default {
    ...
    runOperation() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                let result = this._dataManager.listClientInfo(this._editedClient);
                console.log(result);
...
exports.default = ListClientInfoOperation;
